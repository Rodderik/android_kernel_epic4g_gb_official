...
#define IOCTL_MTP_IOC_MAGIC             0xDF
#define IOCTL_MTP_ENABLE            _IO(IOCTL_MTP_IOC_MAGIC,  0)
#define IOCTL_MTP_DISABLE           _IO(IOCTL_MTP_IOC_MAGIC,  1)
#define IOCTL_MTP_CLEAR_HALT        _IO(IOCTL_MTP_IOC_MAGIC,  2)
#define IOCTL_MTP_WRITE_INT_DATA    _IO(IOCTL_MTP_IOC_MAGIC,  3)
#define IOCTL_MTP_SET_USER_PID      _IO(IOCTL_MTP_IOC_MAGIC,  4)
#define IOCTL_MTP_GET_SETUP_DATA    _IO(IOCTL_MTP_IOC_MAGIC,  6)
#define IOCTL_MTP_SET_SETUP_DATA    _IO(IOCTL_MTP_IOC_MAGIC,  7)
#define IOCTL_MTP_IOC_MAXNR 8
